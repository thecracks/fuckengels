        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#home" data-toggle="tab">Registrar Cursos</a>
                    </li>
                    <li class=""><a href="#listaC" data-toggle="tab">Listar Cursos</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade active in" id="home">
                        <div class="container-fluid">
                            <div class="row" id="registroAreasAcademicas">
                                <div class="col-lg-12">
                                    <center><h3> Registro de Cursos Académicos </h3></center>
                                    <hr />
                                    <div class="row">
                                        <label class="col-lg-1 control-label"></label>
                                        <label class="col-lg-3 control-label">Nombre del Curso</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="txtNombreCurso" placeholder="Nombre del Curso">
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control" required="required" id="sArea">
                                                <?php
                                                foreach ($mostrar1 as $value) {
                                                    echo "<option value='" . $value["idarea"] . "'>";
                                    ...
                                    <div class="row">
                                        ...
                                        <input  type="button" value="Guardar" id="btnGuardarCurso" class="btn btn-success autoajustable">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row tab-pane fade" id="listaC">
                        <div class="container-fluid">
                            <div class="panel-heading">
                                <center><h3>Lista de Cursos Académicos</h3></center>
                            </div>
                            <hr />
                            <div class="panel-body">
                                ...
                                <table class="table table-striped" style="width:55%" align="center">
                                    ...
                                    foreach ($mostrar as $value) {
                                        ...
                                        echo "<td>";
                                        echo "<img src='img/editar.png' style='width:20px' class='puntero' id='editarCurso_" . $value['idcurso'] . "_" . $value['Nombre'] . "_" . $value['Descripcion'] . "'>";
                                        echo "</td>";
                                        
                                        echo "<td>";
                                        echo "<img src='img/eliminar.png' style='width:20px' class='puntero' id='eliminarCurso_" . $value['idcurso'] . "_" . $value['Nombre'] . "_" . $value['Descripcion'] . "''>";
                                        echo "</td>";
                                    }
                                    ?>
                                    </tr>
                                ...
                                <hr />
                                <!--<label class="control-label" style="color: #000077; size: 20px"> * Solo se puede ELIMINAR la filial que aún no se registra inscripción y/o matrículas.</label>-->
                            </div>
                        </div>
                    </div>
                </div>
